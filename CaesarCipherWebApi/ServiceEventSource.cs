...
{
    [EventSource(Name = "MyCompany-CaesarCipherApplication-CaesarCipherWebApi")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        {
            // Solution de contournement au problème des activités ETW qui ne sont pas suivies tant que l'infrastructure Tasks n'est pas initialisée.
            // Ce problème sera corrigé dans .NET Framework 4.6.2.
            Task.Run(() => { });
        }
